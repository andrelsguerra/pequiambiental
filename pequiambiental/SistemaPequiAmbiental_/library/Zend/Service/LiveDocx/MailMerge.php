...
class Zend_Service_LiveDocx_MailMerge extends Zend_Service_LiveDocx
{
    ...
    public function listTemplates()
    {
        ...
        if (isset($result->ListTemplatesResult)) {
            $ret = $this->_backendListrayToMultiAssocArray($result->ListTemplatesResult);
        }
    ...
    public function listSharedDocuments()
    {
        ...
        if (isset($result->ListSharedDocumentsResult)) {
            $ret = $this->_backendListrayToMultiAssocArray(
    ...
    public function listImages()
    {
        ...
        if (isset($result->ListImagesResult)) {
            $ret = $this->_backendListrayToMultiAssocArray($result->ListImagesResult);
        }
     ...
     * @since  LiveDocx 1.0
     */
    protected function _backendListrayToMultiAssocArray($list)
    {
        $this->logIn();
